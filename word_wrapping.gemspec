...
Gem::Specification.new do |spec|
  spec.name          = "word_wrapping"
  spec.version       = WordWrapping::VERSION
  spec.authors       = ["Renny Fadoju"]
  ...
  spec.description   = %q{"To use implement, use WordWrapping::Word.wrap('word',column length)"}
